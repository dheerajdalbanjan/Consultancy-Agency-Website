  ...
  return (
    <form method='post' onSubmit={handleSubmit(submitee)} className=' px-1' >
      <div className='flex flex-col gap-y-2  my-4'>
        ...
        {errors.name && <span className="text-base ml-1 text-red-500 font-light antialised">{errors.name.message}</span>}
      </div>
      <div className='flex flex-col gap-y-2  my-4'>
        ...
        {errors.email && <span className="text-base ml-1 text-red-500 font-light antialised">{errors.email.message}</span>}
      </div>
      <div className='flex flex-col gap-y-2   my-4'>
        
      <label className='md:text-lg  dark:font-thin'>Enter your Problem </label>
        ...
        {errors.category && <span className="text-base ml-1 text-red-500 font-light antialised">{errors.category.message}</span>}
      </div>
      <div className='flex flex-col gap-y-2  my-4'>
        ...
        {errors.message && <span className="text-base ml-1 text-red-500 font-light antialised">{errors.message.message}</span>}
      </div>

...
const Hero = () => {
  ...
  return (
    <div className=' relative    items-center  justify-center  ' style={{backgroundImage: "url('/poster.png')",backgroundSize: "cover",
    backgroundRepeat: "no-repeat",}}>
      ...
      <Badge  variant={'outline'} className='rounded-full text-base mt-4 border-black/50 bg-opacity-20 backdrop-blur-sm'>We here | We Support | We Console</Badge>
        ...
        <h4 className=' text-base font-normal  text-center max-w-lg'>Welcome to OurSoulss, a mental health and wellness platform where you can interact with our top professionals along with non-professionals. We privode 24/7 support to help you at your difficult time in your life. We are here for you always. So join our supportive community today!</h4>

...
const Hero = () => {
  ...
  return (
    <div className='relative overflow-hidden flex mx-auto bg-gradient-to-r from-blue-200 to-yellow-400 from  items-center justify-center  md:py-8 ' style={inter.style}>
  <div   className='flex h-full pt-20  px-8 items-start justify-center max-w-6xl mx-auto pb-20 w-full flex-col gap-y-2 md:gap-y-2 relative z-10' >
    ...
    <motion.img initial={{scale:0.8}} whileInView={{scale: 1}} src='/poster1.png' className=' object-fill'/>
  </div>
  
  </div>

  <div className='absolute bottom-0 w-full h-[20%] bg-gradient-to-t from-[#c1cecc] to-transparent'>

...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col gap-y-2 md:gap-y-3 bg-[#09090b] bg-grid-white/[0.03]   items-center justify-center p-6 pt-20 mx-auto '>
        ...
        <h4 className=' text-base font-thin  text-center max-w-lg'>OurSoulss provides friendly counseling and emotional support, offering guidance in stress management, relationship advice, and career coaching. Join our community for understanding and comfort during challenging times</h4>
